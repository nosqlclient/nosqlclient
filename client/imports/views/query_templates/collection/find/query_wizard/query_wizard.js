  ...
  switch (step) {
    ...
    case 3: {
      ...
      if (selectedOption === '4' || selectedOption === '-4') {
        const convertedValue = Helper.convertAndCheckJSON(txtValue);
    ...
    case 4: {
      ...
      chatDiv.append($(`<div class="right"><div class="author-name">Me </div> <div class="chat-message">${regexOptions || 'No options'}</div></div>`));
      chatDiv.append($('<div class="left"><div class="author-name">Nosqlclient </div> <div class="chat-message active"></div></div>'));
