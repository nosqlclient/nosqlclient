...
Template.addCollection.onRendered(() => {
  $('a[data-toggle="tab"]').on('shown.bs.tab', (e) => {
    ...
    if (target === '#tab-2-engine') UIComponents.Editor.initializeCodeMirror($('#divStorageEngine'), 'txtStorageEngine');
      ...
      UIComponents.Editor.initializeCodeMirror($('#divValidatorAddCollection'), 'txtValidatorAddCollection');
    } else if (target === '#tab-4-collation') UIComponents.Editor.initializeCodeMirror($('#divCollationAddCollection'), 'txtCollationAddCollection');
  });
